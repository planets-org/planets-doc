...
| 5   | 生年月日 | birthDate |  date  |    ○     | -     |       |        | YYYY-MM-DD |          |　        | 生年月日を完全一致検索 |
...
| 4   | ユーザ情報       | user          | 3 | -      | object  | -        | FRUCtoSのPatientリソースの仕様に準拠する<br/>参考：[Patientリソース構造体について](../../../../Plat/resource_patient.md) |
| 5   | バージョン       | version       |  3 | -      | string  | -        | 拡張性(uuid の格納等)を考慮して string 型を使用 |
