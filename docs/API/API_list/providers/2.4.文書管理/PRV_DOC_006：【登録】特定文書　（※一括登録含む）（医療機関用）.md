...
| :-- | :--------------- | :------------ | --- | ------ | :------------ | :--------: | ----- | ------ | ------ | ------------ | -------- | -------- | -------------------------------------------------------------------------------------------------------------------------------- | 
| 1   | Bundle の登録対象リスト | bundleList |  1  | 〇 | array | - | - | - | - | - | - | - |                                                                                                                                 |
| 2   | Bundle 構造体           |            |  2   | - | - | - | - | - | - | - | - | - | OpenFRUCtoS の Bundle リソースの仕様に準拠する<br/>[参考：3.Bundle リソース構造体について](../../../../Plat/resource_bundle.md) |
...
| :-- | :---------------------- | :--------------- | :-: | :-: | :----- | :----- | :------- |
| 1   | Bundle の登録結果リスト | bundleResultList |  1   | ○      | array  | -        |                    |
| 2   | 医療機関 ID             | organizationId   |  2   | -      | string | -        |                    |
| 3   | 状態                    | status           | 2     | -      | string | -        | success：正常      |
| 4   | 診断内容                | diagnostics      |  2    | -      | string | ○        |                    |
| 5   | ID                      | id               |  2    | -      | string | -        | Bundle ID          |
| 6   | 文書キー                | documentKey      | 2   | -      | string | -        |                    |
