...
hu| No. | 項目名   | 物理名     | 属性   | Nullable | 最小文字数 | 最大文字数 | フォーマット | 過去日付 | 未来日付 | 設定要領 |
| :-- | :------- | :-------- | :----: | :------: | ----- | ------ | ----------- | -------- | -------- | :------------------------------------- |
...
| No. | 項目名 | 物理名 | 階層 | 繰返し | 属性 | Nullable  | 最小文字数 | 最大文字数 | フォーマット | 過去日付 | 未来日付 | リクエスト設定要領 |
| :-- | :----- | :----- | --- | ------ | :--- | :------: | ------ | ----- | ------------ | ------- | -------- | ----------------- |
| -   |        |       |        |      |          |     |        |       |              |         |          |                   |
...
| 5   | 医療機関情報       | organization     |  3  | -      | string  | -        | FRUCtoSのOrganizationリソースの仕様に準拠する |
| 6   | Composition 情報   | contents         |  3  | -      | string  | -        | FRUCtoSのOrganizationリソースの仕様に準拠する |
