...
| :---------- | :----------------------------------- | :------------ | :----------------------------------------------------------------------- |
| PRV_ROL_004 | 【取得】権限の要求状態（医療機関用） | GET           | {applicationPath}/providers/permission/requests/{permissionManagementId} |
...
| 2   | ステータス | status  | string |    -     | [権限承認状態](../../../API_Domain_Definition_Table.md)                          |
