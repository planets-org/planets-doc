...
| 2   | Patient 構造体    |     |  2   | - | - | - | - | - | - | - | - | - | OpenFRUCtoSのPatientリソースの仕様に準拠する<br/>参考：[Patientリソース構造体について](../../../../Plat/resource_patient.md) |
...
| :-- | :--------- | :------ | :-: | :----- | :----- | :------- | :---------------------------------------------- |
| 1   | ユーザ情報 | user    |  1  | -      | object | -        | OpenFRUCtoS の Patient リソースの仕様に準拠する |
