...
| :-- | :------- | :-------- | :----: | :------: | ---- | ----- | ------ | ----------- | -------- | -------- | :------------------------------------- | 
| 1   | 参照先  | location   | string |    ○   | - |       |      | self &#124; remote &#124; all  |          |　        | ”self”/”remote”/"all"もしくは医療機関 ID のカンマ区切りを URL エンコードを行い指定 |
...
| 4   | タイトル | title  | string |    ○     | -     |       |        | 制御文字以外  |          |　        | URL エンコードを行う  |
...
| No. | 項目名  | 物理名    |  属性  | Nullable | 桁数 | 最小値 | 最大値 | フォーマット | 過去日付 | 未来日付 | 設定要領                                         |
| :-- | :------ | :-------- | :----: | :------: | --- | ----- | ------ | ----------- | -------- | ------- |:----------------------------------------------- |
| 1   | 患者 ID | patientId | string |    ○     | 100   | -     | -       | 以下の文字と記号のみ可<br/>・a-zA-Z0-9<br/>・記号[・-_.!*'()] | -        | -       | PLAT 共通 ID を URL エンコードを行い設定 |
